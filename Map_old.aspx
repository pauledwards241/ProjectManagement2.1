    ...
    <div id="container">
        ...
        <div id="content">
            <div id="conndiv" style="width: 1000px;">
                <div id="newProject" style="background: white; position: absolute; left: 400px; top: 200px; z-index: 100; display: none;">
                ...
                <div id="data_canvas" style="width: 1000px; background: white; border: solid 1px black;">
                    <script type="text/javascript">
                        ...
                        function saveProject() {
                            var lat = document.getElementById("<%= this._TxtLat.ClientID %>").value;
                            var lng = document.getElementById("<%= this._TxtLng.ClientID %>").value;
                            ...
                            var myMarker = new String("google.maps.MarkerImage/");
                            myMarker = myMarker.concat(status + "/");
                            myMarker = myMarker.concat(dep + ".png");

                            addDatamarkers(lat, lng, project_code, myMarker, '', '', '');
